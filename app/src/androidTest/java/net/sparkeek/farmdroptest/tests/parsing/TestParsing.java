package net.sparkeek.farmdroptest.tests.parsing;
...
public class TestParsing {
    ...
    public void test_Parse_JSONRepo_ParsesRepoDTO() throws IOException {
        ...
        Given:
        {
            lsRepoData = mLocalifyClient.localify().loadRawFile(net.sparkeek.farmdroptest.test.R.raw.repo_octocat);
        }
    ...
    public void test_Parse_JSONArrayRepo_ParsesRepoAsArrayDTO() throws IOException {
        ...
        Given:
        {
            lsRepoDataAsArray = mLocalifyClient.localify().loadRawFile(net.sparkeek.farmdroptest.test.R.raw.repos_octocat);
        }
