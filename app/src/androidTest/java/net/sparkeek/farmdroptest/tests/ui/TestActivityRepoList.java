package net.sparkeek.farmdroptest.tests.ui;
...
import net.sparkeek.farmdroptest.mvp.ActivityMain;
...
public class TestActivityRepoList extends AbstractRobotiumTestCase<ActivityMain> {
    ...
    public void test_ListRepos_WithOneRepo_DisplayListWithOnlyThisRepo() {
        Given:
        {
            final String lsOneRepoJSONData = mLocalifyClient.localify().loadRawFile(net.sparkeek.farmdroptest.test.R.raw.repos_octocat);
