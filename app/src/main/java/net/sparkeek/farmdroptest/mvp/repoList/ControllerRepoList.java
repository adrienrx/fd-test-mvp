...
public class ControllerRepoList
    ...
    @Bind(net.sparkeek.farmdroptest.R.id.ControllerRepoList_ProgressBar_Loading)
    ProgressBar mProgressBarLoading;
    @Bind(net.sparkeek.farmdroptest.R.id.ControllerRepoList_RecyclerView)
    RecyclerView mRecyclerView;

    @Bind(net.sparkeek.farmdroptest.R.id.ControllerRepoList_SwipeRefreshLayout_Empty)
    SwipeRefreshLayout mSwipeRefreshLayoutEmpty;
    @Bind(net.sparkeek.farmdroptest.R.id.ControllerRepoList_SwipeRefreshLayout_Error)
    SwipeRefreshLayout mSwipeRefreshLayoutError;
    @Bind(net.sparkeek.farmdroptest.R.id.ControllerRepoList_SwipeRefreshLayout_Content)
    SwipeRefreshLayout mSwipeRefreshLayoutContent;
    @Bind({
            net.sparkeek.farmdroptest.R.id.ControllerRepoList_SwipeRefreshLayout_Empty,
            net.sparkeek.farmdroptest.R.id.ControllerRepoList_SwipeRefreshLayout_Error,
            net.sparkeek.farmdroptest.R.id.ControllerRepoList_SwipeRefreshLayout_Content
    })
    ...
    protected View onCreateView(@NonNull final LayoutInflater poInflater, @NonNull final ViewGroup poContainer) {
        final View loView = poInflater.inflate(net.sparkeek.farmdroptest.R.layout.controller_repo_list, poContainer, false);
